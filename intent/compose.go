...
// by the actual matched node name. For example, if matchedAfter is "priceOfferByRef"
// and wire has {"offerListIdentifier": "$after.offerRef"}, the result
// will have {"offerListIdentifier": "priceOfferByRef.offerRef"}.
