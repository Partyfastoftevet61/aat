...
func fixDependsOn(p *plan.Plan, g *graph.Graph, stepIndex map[string]bool) {
	...
	// base workflow (e.g., both using addPaymentMethodCash).
	...
	// referencing the base workflow's confirmItinerary).
...
// LLMs sometimes generate filters like "flightOffer.carrier == 'QF'"
