...
- For fieldExists/fieldEquals/predicate assertions, use the output field names listed in the plan flow (e.g., "itineraryId", "pnrLocator") — these are the extracted response fields available at runtime
