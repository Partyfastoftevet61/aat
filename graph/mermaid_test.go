...
func TestGenerateMermaid_AirlineBooking(t *testing.T) {
	...
	assert.Contains(t, result, `ignoreItinerary["ignoreItinerary`)
	...
	assert.Contains(t, result, "createItinerary -.-> ignoreItinerary")
}
