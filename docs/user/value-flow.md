...
The airline project includes several layers that illustrate common use cases:
...
inputs:
  addPaymentMethodCard.cardNumber:
    pool: ["371449635398431", "378282246310005", "340000000000009"]
  addPaymentMethodCard.cardCode: AX
  addPaymentMethodCard.cvv:
    pool: ["1234", "5678", "9012"]
```
