...
```yaml
headers:
  X_ACCESS_GROUP: "00000000-0000-0000-0000-000000000000"
...
If a template produces a path like `/v1/air/search`, the rewrite transforms it to `/api/v2/air/search` before making the request.
