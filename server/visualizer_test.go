...
func TestMatchVisualizers_BodyContains(t *testing.T) {
	defs := []config.VisualizerDef{
		{ID: "flight", Name: "Flight", Match: config.VisualizerMatch{BodyContains: "FlightOffersResponse"}},
...
func TestEnrichStepVisualizers(t *testing.T) {
	s := &Server{
		visualizers: []config.VisualizerDef{
			{ID: "flight", Name: "Flight Search", Match: config.VisualizerMatch{BodyContains: "FlightOffersResponse"}},
		},
	}
