...
// newTestServerWithPlans creates a Server with PlanDirs for testing plan tools.
func newTestServerWithPlans(g *graph.Graph, planDir string) *Server {
	var planDirs []string
	if planDir != "" {
